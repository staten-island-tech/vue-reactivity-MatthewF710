<template>
  <div class="navbar bg-ALDIdarkblue w-full px-6 py-3 flex justify-between items-center shadow-lg">
    <figure>
      <img
        class="h-[5rem]"
    ...
    <h1 class="text-ALDIyellow text-6xl font-ALDIFont">ALDI Clicker</h1>
